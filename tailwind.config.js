...
export default {
  // === تم شب/روز ===
  // «class» یعنی حالت تاریک فقط وقتی فعال می‌شود که کلاس .dark روی یکی از
  // والدهای بالادست (اینجا <html>) وجود داشته باشد — نه صرفاً بر اساس
  // تنظیم سیستم‌عامل کاربر (که حالت پیش‌فرض «media» تیلویند است). این‌طور
  // کاربر می‌تواند از داخل خود سایت تم را دستی عوض کند و انتخابش هم در
  // بازدیدهای بعدی حفظ شود (نگاه کنید به contexts/ThemeContext.jsx).
  darkMode: 'class',
  content: [
    './index.html',
    './src/**/*.{js,jsx,ts,tsx}',
